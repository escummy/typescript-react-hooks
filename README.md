...
```bash
  git clone git@github.com:escummy/typescript-react-hooks.git
```
...
Repositories use [SemVer](http://semver.org/) for versioning, three-digit numbering technique based patter of Major, Minor and Patch fixes, see the [release tags](https://github.com/escummy/typescript-react-hooks/tags) for more details about version available.
...
<p align="center">This <i>README</i> file was updated</br>Last refresh: Wednesday, 23 Nov, 14:08 CET<br/></p>
